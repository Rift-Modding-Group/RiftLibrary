...
import anightdazingzoroark.example.item.StinkyArmorItem;
...
public class ItemRegistry {
    ...
    public static StinkyArmorItem STINKY_HEAD;
    public static StinkyArmorItem STINKY_CHEST;
    public static StinkyArmorItem STINKY_LEGGINGS;
    public static StinkyArmorItem STINKY_BOOTS;
