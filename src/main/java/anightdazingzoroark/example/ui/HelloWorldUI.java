...
public class HelloWorldUI extends RiftLibUI {
    ...
    public List<RiftLibUISection> uiSections() {
        ...
        RiftLibUISection section = new RiftLibUISection("mainSection", this.width, this.height, 166, 156, 0, 0, this.fontRenderer, this.mc) {
            ...
            public List<RiftLibUIElement.Element> defineSectionContents() {
                ...
                helloWorldText.setHasOverlayEffects();
                ...
                introText.setHasOverlayEffects();
                ...
                one.setAlignment(RiftLibUIElement.ALIGN_LEFT);
                one.setScale(0.75f);
                //introText.setSingleLine();
                ...
                textBoxSection.setHasOverlayEffects();
                ...
                progressBarElement.setHasOverlayEffects();
                ...
                renderedEntityElement.setHasOverlayEffects();
    ...
    public void onButtonClicked(RiftLibButton button) {
        if (button.buttonId.equals("myButton")) {
            ...
            popupTextElement.setText("This is a popup!");
