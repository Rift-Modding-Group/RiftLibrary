...
public class AnimationDataEntity extends AbstractAnimationData<EntityLivingBase> {
    ...
    @Override
    protected HashMap<String, BiFunction<AbstractAnimationData<EntityLivingBase>, MolangParser, Double>> getMolangQueries() {
        HashMap<String, BiFunction<AbstractAnimationData<EntityLivingBase>, MolangParser, Double>> toReturn = super.getMolangQueries();
        ...
        toReturn.put("query.health", (animData, parser) -> {
            return (double) this.getHolder().getHealth();
        });
        toReturn.put("query.max_health", (animData, parser) -> {
        ...
        toReturn.put("query.is_riding", (animData, parser) -> {
