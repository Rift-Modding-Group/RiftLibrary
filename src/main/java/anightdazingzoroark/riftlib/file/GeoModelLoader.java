...
public class GeoModelLoader {
	public GeoModel loadModel(IResourceManager resourceManager, ResourceLocation location) {
		try {
            ...
            anightdazingzoroark.riftlib.newGeo.raw.RawGeoModel newRawGeoModel = anightdazingzoroark.riftlib.newGeo.Converter.convertModelJSONToRawGeoModel(AnimationFileLoader.getResourceAsString(location, resourceManager));

            System.out.println(newRawGeoModel);
