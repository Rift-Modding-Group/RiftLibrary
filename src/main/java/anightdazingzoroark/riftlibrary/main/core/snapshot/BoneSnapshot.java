package anightdazingzoroark.riftlibrary.main.core.snapshot;

import anightdazingzoroark.riftlibrary.main.geo.basic.RiftLibBone;

public class BoneSnapshot {
    public BoneSnapshot(RiftLibBone modelRenderer) {
    ...
    public BoneSnapshot(RiftLibBone modelRenderer, boolean dontSaveRotations) {
    ...
    public String name;
    private RiftLibBone modelRenderer;
