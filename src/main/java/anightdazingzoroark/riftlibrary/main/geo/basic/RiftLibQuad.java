...
public class RiftLibQuad {
    public RiftLibVertex[] vertices;
    public final Vec3i normal;
    public EnumFacing direction;

    public RiftLibQuad(RiftLibVertex[] verticesIn, float u1, float v1, float uSize, float vSize, float texWidth,
    ...
    public RiftLibQuad(RiftLibVertex[] verticesIn, int[] uvCoords, int[] uvSize, float texWidth, float texHeight,
