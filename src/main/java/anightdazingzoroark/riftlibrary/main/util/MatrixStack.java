...
public class MatrixStack {
    ...
    public void moveToPivot(RiftLibCube cube) {
        Vector3f pivot = VectorUtils.convertToJavaVec3f(cube.pivot);
        this.translate(pivot.getX() / 16, pivot.getY() / 16, pivot.getZ() / 16);
    }

    public void moveBackFromPivot(RiftLibCube cube) {
        Vector3f pivot = VectorUtils.convertToJavaVec3f(cube.pivot);
        this.translate(-pivot.getX() / 16, -pivot.getY() / 16, -pivot.getZ() / 16);
    }

    public void moveToPivot(RiftLibBone bone) {
        this.translate(bone.rotationPointX / 16, bone.rotationPointY / 16, bone.rotationPointZ / 16);
    }

    public void moveBackFromPivot(RiftLibBone bone) {
        this.translate(-bone.rotationPointX / 16, -bone.rotationPointY / 16, -bone.rotationPointZ / 16);
    }

    public void translate(RiftLibBone bone) {
    ...
    public void translate(AnimatedLocator locator) {
        Vector3f locatorPos = locator.getModelSpacePosition();
    ...
    public void scale(RiftLibBone bone) {
    ...
    public void rotate(RiftLibBone bone) {
    ...
    public void rotate(RiftLibCube bone) {
        Vector3f rotation = VectorUtils.convertToJavaVec3f(bone.rotation);
